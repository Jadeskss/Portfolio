...
document.addEventListener('DOMContentLoaded', function() {
  ...
  chatForm.addEventListener('submit', function(e) {
    ...
    // Simulate email sending (with email not available notice)
    setTimeout(() => {
      chatFormStatus.innerHTML = '<div class="alert alert-warning"><i class="fas fa-exclamation-triangle"></i> Email service is currently unavailable. This is a portfolio demo.</div>';
      chatForm.reset();
      ...
      setTimeout(() => {
        ...
        // Add the notice again after a few seconds
        setTimeout(() => {
          if (!document.getElementById('email-notice') && isModalVisible) {
            const noticeDiv = document.createElement('div');
            noticeDiv.id = 'email-notice';
            noticeDiv.className = 'alert alert-info';
            noticeDiv.innerHTML = '<i class="fas fa-info-circle"></i> Alert: Email functionality is currently unavailable.';
